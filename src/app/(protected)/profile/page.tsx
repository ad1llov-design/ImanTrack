        ...
        <div className="space-y-6">
          ...
          <GlassCard>
            ...
            <div className="flex items-center gap-4">
              <a href="https://wa.me/+996557555058" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-2xl bg-green-50 text-green-600 hover:bg-green-100 dark:bg-green-950/30 dark:hover:bg-green-900/50 transition-colors shadow-sm">
              ...
              <a href="https://t.me/@xwvllxx" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-2xl bg-blue-50 text-blue-500 hover:bg-blue-100 dark:bg-blue-950/30 dark:hover:bg-blue-900/50 transition-colors shadow-sm">
              ...
              <a href="https://www.instagram.com/ad1llov.o1?igsh=MnhiNjlpaTdocHVw" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 rounded-2xl bg-pink-50 text-pink-600 hover:bg-pink-100 dark:bg-pink-950/30 dark:hover:bg-pink-900/50 transition-colors shadow-sm">
